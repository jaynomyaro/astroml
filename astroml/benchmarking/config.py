...
class ModelConfig:
    ...
    params: dict[str, Any]
    task_type: str = (
        "classification"  # classification, link_prediction, anomaly_detection, regression
    )
...
class BenchmarkConfig:
    ...
    @classmethod
    def load(cls, filepath: str | Path) -> BenchmarkConfig:
...
class ConfigManager:
    ...
    def create_default_configs(self) -> None:
        ...
        link_config = BenchmarkConfig(
            ...
            model=ModelConfig(
                name="link_predictor",
                params={"in_channels": 16, "hidden_channels": 64, "num_layers": 2, "dropout": 0.5},
        ...
        svdd_config = BenchmarkConfig(
            ...
            training=TrainingConfig(learning_rate=0.001, loss_function="deep_svdd"),
        )
        self.add_config(svdd_config)


def create_config_from_template(
    name: str, model_name: str, task_type: str = "classification", **kwargs
) -> BenchmarkConfig:
    ...
    return BenchmarkConfig(
        ...
        model=ModelConfig(name=model_name, params=model_params[model_name], task_type=task_type),
