...
def demonstrate_single_model_calibration():
    ...
    fig = analyzer.plot_calibration_curve(
        y_true, y_prob, model_name="Fraud Detection Model", figsize=(15, 10)
    )

    # Generate detailed report
    report = analyzer.generate_calibration_report(
        y_true, y_prob, model_name="Fraud Detection Model"
    )
...
def demonstrate_multi_model_comparison():
    ...
    fig = analyzer.plot_multiple_models(models_data, figsize=(16, 12))
...
def demonstrate_threshold_optimization():
    ...
    results = {"threshold": [], "precision": [], "recall": [], "f1": [], "calibration_error": []}
